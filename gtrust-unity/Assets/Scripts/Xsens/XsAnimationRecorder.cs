...
namespace xsens
{
    ...
    public class XsAnimationRecorder : MonoBehaviour
    {
        ...
        private readonly Dictionary<EditorCurveBinding, int> curveToMuscle = new();
        ...
        private HumanPose humanPose = new();
        private HumanPoseHandler humanPoseHandler;
        private readonly Dictionary<int, EditorCurveBinding> indexToCurve = new();
        ...
        /// <summary>
        ///     Initialize our objects and setup Dictionaries to hold the conneciton between the EditorCurveBinding and the
        ...
        /// <summary>
        ///     Add the root transform data to the indexToCurve Dictionary and setup the indecies in the binableCurves array since
        ///     this data isn't found in HumanPose.muscles.
        ...
        private void SetupRootCurves()
        {
            ...
            for (var i = 0; i < bindableCurves.Length; i++)
            {
                if (
        ...
        /// <summary>
        ///     Add the finger data to the indexToCurve Dictionary and setup the indecies in the binableCurves array since the
        ///     indecies that match HumanPose.muscles isn't found in HumanTrait.MuscleName for some reason.
        ...
        /// <summary>
        ///     Add the body data to the CurveToMuscle and indexToCurve Dictionaries and setup the indecies in the binableCurves
        ///     array.
        ...
        private void SetupBodyCurves()
        {
            ...
            for (var i = 0; i < bindableCurves.Length; i++)
            {
                for (var j = 0; j < HumanTrait.MuscleName.Length; j++)
                {
        ...
        private void OnGUI()
        {
            if (saveProptOpen)
            {
                var windowRect = new Rect(Screen.width / 2 - 150, Screen.height / 2 - 150, 300, 150);
        ...
        private void SavePrompt(int windowID)
        {
        ...
        /// <summary>
        ///     This runs as a corrutine the entire time of recording and adds keyframes to all curves each frame that can later be
        ///     connected to an animationClip.
        /// </summary>
        private IEnumerator Record()
        {
            ...
            while (recording)
            {
                ...
                for (var i = 0; i < recordedCurvesCount - 47; i++)
                {
                ...
                for (var i = recordedCurvesCount - 48; i < recordedCurvesCount - 7; i++)
                {
        ...
        /// <summary>
        ///     Use the AnimationUtility to save our AnimationCurves to the correct EditorCurveBindings and then save our new clip
        ///     to disk
        /// </summary>
        private void SaveRecording()
        {
            ...
            for (var i = 0; i < recordedCurvesCount; i++)
            {
