...
{
    private readonly List<HMI> _hmis = new();
    private UNetClient _client;
    ...
    private void OnRequestHMIChange(ISynchronizer sync, int _)
    {
    ...
    //hmi syncing message
    private struct RequestHMIChangeMsg : INetMessage
    {
